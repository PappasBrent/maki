...
// CHECK:     "IsObjectLike": true,
// CHECK:     "IsDefinitionLocationValid": true,
// CHECK:     "DefinitionLocation": "{{.*}}/Tests/continue_inside_do_while.c:4:9"
// CHECK:   },
// CHECK:   {
// CHECK:     "PropertiesOf": "Invocation",
// CHECK:     "Name": "DO_NOTHING",
// CHECK:     "DefinitionLocation": "{{.*}}/Tests/continue_inside_do_while.c:4:9",
// CHECK:     "EndDefinitionLocation": "{{.*}}/Tests/continue_inside_do_while.c:7:13",
// CHECK:     "InvocationLocation": "{{.*}}/Tests/continue_inside_do_while.c:10:5",
// CHECK:     "ASTKind": "Stmt",
