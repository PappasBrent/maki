...
// CHECK:     "IsObjectLike": true,
// CHECK:     "IsDefinitionLocationValid": true,
// CHECK:     "DefinitionLocation": "{{.*}}/Tests/bit_field.c:4:9"
// CHECK:   },
// CHECK:   {
// CHECK:     "PropertiesOf": "Invocation",
// CHECK:     "Name": "WORD",
// CHECK:     "DefinitionLocation": "{{.*}}/Tests/bit_field.c:3:9",
// CHECK:     "EndDefinitionLocation": "{{.*}}/Tests/bit_field.c:3:14",
// CHECK:     "InvocationLocation": "{{.*}}/Tests/bit_field.c:7:13",
// CHECK:     "ASTKind": "Expr",
...
// CHECK:     "Name": "BYTE",
// CHECK:     "DefinitionLocation": "{{.*}}/Tests/bit_field.c:4:9",
// CHECK:     "EndDefinitionLocation": "{{.*}}/Tests/bit_field.c:4:18",
// CHECK:     "InvocationLocation": "{{.*}}/Tests/bit_field.c:8:14",
// CHECK:     "ASTKind": "Expr",
